$(function all () {
 $all =
     ...
     + "<a href='seventyFirst.html' class='book' value='2017.11.22'>Node.js——基本模块(4)</a>"
     + "<a href='nodeJsSet.html' class='set' value='2017.11.16'>Node.js学习的合集</a>"
     + "<a href='seventieth.html' class='book' value='2017.11.16'>Node.js——模块原理(3)</a>"
     + "<a href='sixtyNinth.html' class='book' value='2017.11.15'>Node.js——模块(2)</a>"
     + "<a href='sixtyEighth.html' class='book' value='2017.11.15'>Node.js——注意事项 + 第一个小程序(1)</a>"
     ...
     + "<a href='fiftyFifth.html' class='book' value='2017.9.6'>JSON学习(1)</a>"
    ...
    $reader = (function reader() {
        ...
        return " 该栏阅读量: " + localStorage.pagecount;
    })();
});
